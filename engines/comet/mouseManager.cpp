...
namespace Cometengine {
	...
	uint32 MouseManager::getButStatus() {
		return ((_leftButStatus ? 2 : 0) | (_rightButStatus ? 1 : 0));
	}
	...
	*/
	...
	const MouseManager::mouseTarget MouseManager::skullMouseTarget[] = {
		{0x76,0x2c,0x8e,0x3b,0},
		{0x8f,0x2c,0xa7,0x3b,1},
		{0xa8,0x2c,0xc0,0x3b,2},
		{0xc1,0x2c,0xd9,0x3b,3},
		{0xd9,0x3b,0xe7,0x53,4},
		{0xd9,0x54,0xe7,0x6c,5},
		{0xd9,0x6d,0xe7,0x85,6},
		{0xd9,0x86,0xe7,0x9e,7},
		{0x76,0x9e,0x8e,0xab,8},
		{0x8f,0x9e,0xa7,0xab,9},
		{0xa8,0x9e,0xc0,0xab,0x0a},
		{0xc1,0x9e,0xd9,0xab,0x0b},
		{0x67,0x3b,0x76,0x53,0x0c},
		{0x67,0x54,0x76,0x6c,0x0d},
		{0x67,0x6d,0x76,0x85,0x0e},
		{0x67,0x86,0x76,0x9e,0x0f},
		{0x67,0x2c,0x76,0x3b,0x10},
		{0xd9,0x2c,0xe7,0x3b,0x11},
		{0xd9,0x9e,0xe7,0xab,0x12},
		{0x67,0x9e,0x76,0xab,0x12},
		{0x77,0x3c,0xd8,0x9d,0x14}
	};
	const MouseManager::mouseTarget MouseManager::quitMenuMouseTarget[] = {
